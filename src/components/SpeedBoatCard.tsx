...
type SpeedBoatCardProps = {
  boat: SpeedboatsType;
};

export const SpeedBoatCard = ({ boat }: SpeedBoatCardProps) => {
  return (
    <div className="relative z-[100] bg-white rounded-xl shadow-lg overflow-hidden group hover:shadow-xl transition-shadow">
