...
import { BiCalendar, BiCalendarAlt, BiRadar, BiUser } from "react-icons/bi";
...
export const Speedboat = () => {
  ...
  // When boat not found
  if (!boat) return <div className="text-center mt-10">Boat not found.</div>;
          ...
          <div className="my-10">
            ...
            <div className="flex flex-col justify-between items-start">
              ...
              <div className="flex">
                ...
                >
                  <BiCalendarAlt className="h-5 w-5 mr-2" />
                  Book Now
                </Link>
              </div>
            </div>
                  ...
                  <div className="grid grid-cols-2 gap-6 items-start w-full md5:grid-cols-4">
                    <div className="flex gap-3">
                      <div className="bg-accent-100 rounded-full w-12 h-12 flex items-center justify-center mb-2">
                        <BiRadar className="h-6 w-6 text-accent-600" />
                      </div>
                    ...
                    <div className="flex gap-3">
                      <div className="bg-accent-100 rounded-full w-12 h-12 flex items-center justify-center mb-2">
                        <BiUser className="h-6 w-6 text-accent-600" />
                      </div>
                      <div className="text-xl text-gray-900">
                    ...
                    <div className="flex gap-3">
                      <div className="bg-accent-100 rounded-full w-12 h-12 flex items-center justify-center mb-2">
                        <FaGauge className="h-6 w-6 text-accent-600" />
                      </div>
                      <div className="text-xl text-gray-900">
                    ...
                    <div className="flex gap-3">
                      <div className="bg-accent-100 rounded-full w-12 h-12 flex items-center justify-center mb-2">
                        <BiCalendar className="h-6 w-6 text-accent-600" />
                      </div>
                      <div className="text-xl text-gray-900">
